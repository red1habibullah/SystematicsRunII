...
for i,fileKey in enumerate(fileDir1):
    ...
    globals()["DataC" + fileKey].SetLineColor(1)
    globals()["DataC" + fileKey].SetMarkerSize(2)
    globals()["DataC" + fileKey].SetMarkerColor(1)
    globals()["DataC" + fileKey].SetLineWidth(3)
    
    globals()["DatadrivenD" + fileKey].SetLineColor(2)
    globals()["DatadrivenD" + fileKey].SetMarkerColor(2)
    globals()["DatadrivenD" + fileKey].SetMarkerSize(1)
    globals()["DatadrivenD" + fileKey].SetLineWidth(3)
    

    globals()["DataC" + fileKey].GetYaxis().SetRangeUser(0, globals()["DataC" + fileKey].GetMaximum()*2)  
    legend.AddEntry(globals()["DataC" + fileKey], "Observed", "elp") 
    legend.AddEntry(globals()["DatadrivenD" + fileKey], "Datadriven", "elp")
    ...
    globals()["DataC" + fileKey].Draw("elp")                                                                                    
    globals()["DatadrivenD" + fileKey].Draw("elp same") 
   ...
   #globals()["dataHist2" + fileKey].Write()
    ...
    canvas.SaveAs("../data/plots_sidebandValidation/" + histKey + "_fakerateUncertainty_singleBin" + fakeEffHist[i] + ".png")  

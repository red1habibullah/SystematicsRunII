...
fileDir1 = ["InvertedMu2Iso_DM0/", "InvertedMu2Iso_DM1/", "InvertedMu2Iso_DM5/", "InvertedMu2Iso_DM10/"]
fileDir2 = ["InvertedMu2Iso_InvertedTauIso_DM0/", "InvertedMu2Iso_InvertedTauIso_DM1/","InvertedMu2Iso_InvertedTauIso_DM5/", "InvertedMu2Iso_InvertedTauIso_DM10/"]
...
fakeEffHist = ["decayMode0", "decayMode1", "decayMode6","decayMode10"]
...
for i,fileKey in enumerate(fileDir1):
    ...
    globals()["dataFile1" + fileKey] = ROOT.TFile(baseDir+fileDir1[i] + "data.root")
    globals()["dataFile2" + fileKey] = ROOT.TFile(baseDir+fileDir2[i] + "data.root")
...
pad1.cd()
globals()["Percentage" ].GetYaxis().SetRangeUser(0, 120)  
...
canvas.SaveAs("../data/plots_sidebandValidation/" + histKey + "teth_fakerateUncertainty_combine_percentage_New" + ".png")  
